...
public class Convolution {
        ...
        /**
         * Initializes the convolution given to signals
         * @param signal the signal to convolve with e.g. a window
         * @param h the second signal for convolution e.g. a window  
         */
